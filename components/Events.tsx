    ...
    <section className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Присоединяйтесь к нашим увлекательным событиям! Мастер-классы, живая музыка, тематические
          вечера и многое другое ждет вас в "Бар-да-бар".
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {upcomingEvents.map((event) => {
          ...
          const typeColor =
            eventTypes[event.type as keyof typeof eventTypes]?.color || 'bg-gray-100 text-gray-700';
              ...
              <CardHeader className="p-0">
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    ...
                    {event.isRecurring && (
                      <Badge className="bg-orange-100 text-orange-700 text-xs">Регулярно</Badge>
                    )}
                    {event.isFree && (
                      <Badge className="bg-green-100 text-green-700 text-xs">Бесплатно</Badge>
                    )}
                  </div>
                </div>
              </CardHeader>
